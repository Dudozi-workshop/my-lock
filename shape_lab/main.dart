...
const _candidates = <_CrayonCandidate>[
  _CrayonCandidate(
    ...
    intent: '현 기준. 색이 매끈하게 뭉개지는 문제를 비교하기 위한 기준점.',
    badge: 'BASE',
  ...
  _CrayonCandidate(
    id: 'G02',
    name: 'Thin Hatch',
    intent: '얇은 선을 많이 남겨 크레용 결 자체가 보이게 한 선형 후보.',
    badge: 'HATCH',
    config: CrayonTextureSpec(
      darkStrokeCount: 32,
      lightStrokeCount: 14,
  ...
  _CrayonCandidate(
    id: 'G03',
    name: 'Rough Wax',
    intent: '굵은 압력 자국과 빈틈을 크게 두어 손칠 느낌을 강하게 만든 후보.',
    badge: 'ROUGH',
    config: CrayonTextureSpec(
      darkStrokeCount: 11,
      lightStrokeCount: 5,
      ...
      edgeWidth: 6.2,
      edgeTexture: 0.95,
      underpaintOpacity: 0.58,
      strokeBreakChance: 0.18,
      strokeBuiltSurface: true,
      broadStrokeCount: 13,
      broadStrokeWidth: 8.5,
      broadStrokeOpacity: 0.34,
      angleJitterDeg: 18.0,
      strokeWidthJitter: 0.36,
  ...
  _CrayonCandidate(
    id: 'G04',
    name: 'Soft Pastel',
    intent: '밝은 획과 미세 입자를 늘려 포근하고 분필 같은 방향을 비교.',
    badge: 'SOFT',
    config: CrayonTextureSpec(
      darkStrokeCount: 20,
      lightStrokeCount: 24,
  ...
  _CrayonCandidate(
    id: 'G05',
    name: 'Dense Scribble',
    intent: '짧고 겹치는 획을 많이 사용해 실제 크레파스 채색처럼 밀도를 강조.',
    badge: 'DENSE',
    config: CrayonTextureSpec(
      darkStrokeCount: 38,
      lightStrokeCount: 10,
      ...
      edgeWidth: 4.8,
      edgeTexture: 0.52,
      underpaintOpacity: 0.64,
      strokeBreakChance: 0.15,
      strokeBuiltSurface: true,
      broadStrokeCount: 34,
  ...
  _CrayonCandidate(
    id: 'G06',
    name: 'Mockup Target',
    intent: '목업의 사선 크레용 결을 목표로, 선명한 실루엣과 내부 손칠을 절충.',
    badge: 'TARGET',
    config: CrayonTextureSpec(
      darkStrokeCount: 28,
      lightStrokeCount: 9,
      ...
      edgeWidth: 4.4,
      edgeTexture: 0.44,
      underpaintOpacity: 0.72,
      strokeBreakChance: 0.09,
      strokeBuiltSurface: true,
      broadStrokeCount: 27,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _SectionTitle(
          title: 'Crayon Soft · Round 8 · High Separation',
          subtitle: '후보 차이가 실제 58px에서도 바로 보이도록 underpaint·획 굵기·밀도·거칠기·명암 폭을 의도적으로 크게 벌린 탐색 라운드입니다.',
          fg: widget.fg,
          muted: widget.muted,
        ),
        const SizedBox(height: 12),
