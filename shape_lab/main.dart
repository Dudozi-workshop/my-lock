...
const _candidates = <_CrayonCandidate>[
  _CrayonCandidate(
    id: 'C01',
    name: 'Current Hand Fill',
    intent: '현재 손칠형 엔진 기준. 다음 후보들의 비교 출발점.',
    badge: 'BASE',
    config: CrayonTextureSpec(
      ...
      edgeWidth: 2.55,
      edgeTexture: 0.34,
      underpaintOpacity: 0.26,
      strokeBreakChance: 0.055,
      strokeBuiltSurface: true,
      broadStrokeCount: 29,
      broadStrokeWidth: 4.20,
      broadStrokeOpacity: 0.31,
      angleJitterDeg: 5.0,
      strokeWidthJitter: 0.17,
  ...
  _CrayonCandidate(
    id: 'C02',
    name: 'Outline + Diagonal',
    intent: '외곽을 먼저 한 번 그리고, 내부를 일정한 사선으로 채운 느낌.',
    badge: '1 PASS',
    config: CrayonTextureSpec(
      darkStrokeCount: 44,
      lightStrokeCount: 8,
      ...
      edgeWidth: 2.65,
      edgeTexture: 0.12,
      underpaintOpacity: 0.20,
      strokeBreakChance: 0.025,
      strokeBuiltSurface: true,
      broadStrokeCount: 31,
      broadStrokeWidth: 4.00,
      broadStrokeOpacity: 0.30,
      angleJitterDeg: 2.2,
      strokeWidthJitter: 0.10,
  ...
  _CrayonCandidate(
    id: 'C03',
    name: 'Double Outline + Multi Fill',
    intent: '외곽을 겹쳐 그리고 내부는 각도와 길이가 조금씩 다른 여러 획으로 채움.',
    badge: '2 PASS',
    config: CrayonTextureSpec(
      darkStrokeCount: 42,
      lightStrokeCount: 12,
      ...
      broadStrokeOpacity: 0.31,
      angleJitterDeg: 8.0,
      strokeWidthJitter: 0.22,
      strokeLengthMin: 0.54,
  ...
  _CrayonCandidate(
    id: 'C04',
    name: 'Rough Hand Drawn',
    intent: '외곽과 내부 모두 흔들림을 키워 레퍼런스의 손그림 느낌을 강하게 재현.',
    badge: 'ROUGH',
    config: CrayonTextureSpec(
      darkStrokeCount: 38,
      lightStrokeCount: 12,
  ...
  _CrayonCandidate(
    id: 'C05',
    name: 'Clear Shape + Rough Fill',
    intent: '실루엣은 또렷하게 유지하고 내부만 손으로 여러 번 문질러 칠한 느낌.',
    badge: 'CLEAR',
    config: CrayonTextureSpec(
      darkStrokeCount: 41,
      lightStrokeCount: 11,
      ...
      edgeWidth: 2.85,
      edgeTexture: 0.24,
      underpaintOpacity: 0.13,
      strokeBreakChance: 0.11,
      strokeBuiltSurface: true,
      broadStrokeCount: 27,
      broadStrokeWidth: 4.30,
      broadStrokeOpacity: 0.32,
      angleJitterDeg: 12.0,
      strokeWidthJitter: 0.30,
      strokeLengthMin: 0.46,
      strokeLengthMax: 0.95,
      gapChance: 0.085,
      toneVariation: 0.11,
    ),
  ),
  _CrayonCandidate(
    id: 'C06',
    name: 'Rough Edge + Soft Fill',
    intent: '외곽선은 손으로 그린 흔적을 살리고 내부 채색은 포근하고 밀도 있게.',
    badge: 'SOFT',
    config: CrayonTextureSpec(
      darkStrokeCount: 34,
      lightStrokeCount: 14,
      ...
      edgeWidth: 3.00,
      edgeTexture: 0.82,
      underpaintOpacity: 0.34,
      strokeBreakChance: 0.055,
      strokeBuiltSurface: true,
      broadStrokeCount: 34,
      broadStrokeWidth: 4.35,
      broadStrokeOpacity: 0.29,
      angleJitterDeg: 6.5,
      strokeWidthJitter: 0.18,
  ...
  _CrayonCandidate(
    id: 'C07',
    name: 'Paper Gap',
    intent: '종이 바탕이 군데군데 비치는 크레파스 특유의 빈틈을 적극적으로 살림.',
    badge: 'GAPS',
    config: CrayonTextureSpec(
      darkStrokeCount: 34,
      lightStrokeCount: 9,
      ...
      edgeWidth: 2.85,
      edgeTexture: 0.62,
      underpaintOpacity: 0.04,
      strokeBreakChance: 0.16,
      strokeBuiltSurface: true,
      broadStrokeCount: 23,
      broadStrokeWidth: 4.50,
      broadStrokeOpacity: 0.33,
      angleJitterDeg: 12.0,
      strokeWidthJitter: 0.28,
      strokeLengthMin: 0.40,
  ...
  _CrayonCandidate(
    id: 'C08',
    name: 'Reference Balanced',
    intent: '레퍼런스의 같은 색 외곽선 + 손칠 내부를 MY LOCK용으로 조금 정돈한 타깃안.',
    badge: 'TARGET',
    config: CrayonTextureSpec(
      darkStrokeCount: 40,
      lightStrokeCount: 11,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _SectionTitle(
          title: 'Crayon Soft · Round 5 · Hand-drawn Crayon',
          subtitle: '레퍼런스처럼 같은 색 크레파스로 외곽을 먼저 그리고 내부를 직접 칠한 느낌을 비교합니다. 흰 테두리·별도 색 테두리는 사용하지 않습니다.',
          fg: widget.fg,
          muted: widget.muted,
        ),
        const SizedBox(height: 12),
...
String _shortCrayonConfig(CrayonTextureSpec config) {
  return 'Broad ' +
      ...
      ' · Gap ' +
      config.gapChance.toStringAsFixed(2) +
      ' · Angle±' +
      config.angleJitterDeg.toStringAsFixed(0) +
      ' · Edge ' +
      config.edgeWidth.toStringAsFixed(1);
}
