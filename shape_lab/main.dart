...
const _candidates = <_CrayonCandidate>[
  _CrayonCandidate(
    id: 'R03',
    name: 'True Paper Gap · Selected',
    intent: 'Round 13 최종 선호안. 밝은 pigment 대신 실제 negative space가 보이는 기준형.',
    badge: 'SELECTED',
  ...
  _CrayonCandidate(
    id: 'R03-A',
    name: 'Clean Paper',
    intent: 'R03의 공백 구조는 유지하고 grain·break를 줄여 더 정돈된 손칠로 다듬은 안.',
    badge: 'REFINE',
    config: CrayonTextureSpec(
      darkStrokeCount: 31,
      lightStrokeCount: 4,
  ...
  _CrayonCandidate(
    id: 'R03-B',
    name: 'Fine Paper',
    intent: '공백을 더 자주 넣되 가늘게 만들어 종이결처럼 섬세하게 읽히는 안.',
    badge: 'REFINE',
    config: CrayonTextureSpec(
      darkStrokeCount: 31,
      lightStrokeCount: 4,
      ...
      strokeLengthMin: 0.76,
      strokeLengthMax: 0.98,
      gapChance: 0.040,
      toneVariation: 0.10,
      negativeGapCount: 13,
      negativeGapWidth: 0.52,
    ),
  ),
  _CrayonCandidate(
    id: 'R03-C',
    name: 'Soft Dry Paper',
    intent: 'R03에 아주 약한 dry grain과 압력 편차만 추가해 감성은 살리고 거칠기는 억제한 안.',
    badge: 'REFINE',
    config: CrayonTextureSpec(
      darkStrokeCount: 30,
      lightStrokeCount: 4,
      ...
      toneVariation: 0.12,
      negativeGapCount: 10,
      negativeGapWidth: 0.68,
    ),
  ),
  _CrayonCandidate(
    id: 'R03-D',
    name: 'Open Paper',
    intent: '공백 수는 줄이고 폭을 넓혀 덜 칠해진 종이 면이 더 분명하게 보이는 실험안.',
    badge: 'REFINE',
    config: CrayonTextureSpec(
      darkStrokeCount: 30,
      lightStrokeCount: 4,
  ...
  _CrayonCandidate(
    id: 'R03-E',
    name: 'Dense Paper',
    intent: 'R03의 paper gap은 유지하면서 pigment coverage를 조금 높여 실제 사용 크기 안정성을 보는 안.',
    badge: 'REFINE',
    config: CrayonTextureSpec(
      darkStrokeCount: 34,
      lightStrokeCount: 4,
      ...
      angleJitterDeg: 4.3,
      strokeWidthJitter: 0.16,
      strokeLengthMin: 0.80,
      strokeLengthMax: 1.0,
      gapChance: 0.030,
      toneVariation: 0.09,
      negativeGapCount: 8,
      negativeGapWidth: 0.62,
    ),
  ),
];
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _SectionTitle(
          title: 'Crayon Soft · Round 14 · R03 Refinement',
          subtitle: 'Round 13에서 R03 True Paper Gap을 최선호안으로 선정했습니다. P01 Clean Edge와 R03의 기본 문법은 고정하고, paper gap의 빈도·폭·dryness·coverage만 좁게 비교합니다.',
          fg: widget.fg,
          muted: widget.muted,
        ),
        const SizedBox(height: 12),
