...
const _candidates = <_CrayonCandidate>[
  _CrayonCandidate(
    id: 'F01',
    name: 'Baseline Fill',
    intent: 'P01 Clean Edge 외곽을 고정한 내부 기준안.',
    badge: 'BASE',
  ...
  _CrayonCandidate(
    id: 'F02',
    name: 'Light Gap',
    intent: '밑칠과 면 채움을 줄여 작은 공백이 자연스럽게 남는 안.',
    badge: 'FOCUS',
    config: CrayonTextureSpec(
      darkStrokeCount: 29,
      lightStrokeCount: 13,
  ...
  _CrayonCandidate(
    id: 'F03',
    name: 'Dry Wax',
    intent: '마른 크레용 압력 편차와 종이결 같은 드라이한 내부 질감.',
    badge: 'FOCUS',
    config: CrayonTextureSpec(
      darkStrokeCount: 27,
      lightStrokeCount: 16,
      ...
      strokeBuiltSurface: true,
      broadStrokeCount: 9,
      broadStrokeWidth: 3.8,
      broadStrokeOpacity: 0.13,
      angleJitterDeg: 6.4,
  ...
  _CrayonCandidate(
    id: 'F04',
    name: 'Scribble Fill',
    intent: '짧고 흔들리는 획을 늘려 슥슥 낙서하듯 칠한 느낌.',
    badge: 'EXP',
    config: CrayonTextureSpec(
      darkStrokeCount: 28,
      lightStrokeCount: 13,
      ...
      edgeOpacity: 0.31,
      edgeWidth: 3.45,
      underpaintOpacity: 0.61,
      strokeBreakChance: 0.145,
      strokeBuiltSurface: true,
      broadStrokeCount: 10,
      ...
      strokeLengthMin: 0.52,
      strokeLengthMax: 0.84,
      gapChance: 0.10,
      toneVariation: 0.14,
      edgeMode: CrayonEdgeMode.hybrid,
      edgeSegmentLength: 11.2,
  ...
  _CrayonCandidate(
    id: 'F05',
    name: 'Half-Filled',
    intent: '의도적으로 덜 메운 극단값. 허용 가능한 공백 한계를 확인.',
    badge: 'LIMIT',
    config: CrayonTextureSpec(
      darkStrokeCount: 24,
      lightStrokeCount: 10,
      ...
      broadStrokeCount: 7,
      broadStrokeWidth: 3.9,
      broadStrokeOpacity: 0.11,
      angleJitterDeg: 7.8,
      strokeWidthJitter: 0.30,
      strokeLengthMin: 0.50,
      strokeLengthMax: 0.82,
      gapChance: 0.145,
      toneVariation: 0.15,
      edgeMode: CrayonEdgeMode.hybrid,
      edgeSegmentLength: 11.2,
  ...
  _CrayonCandidate(
    id: 'F06',
    name: 'Layered Patch',
    intent: '부분별 덧칠과 압력 차이를 살려 불완전함과 밀도를 균형화.',
    badge: 'FOCUS',
    config: CrayonTextureSpec(
      darkStrokeCount: 30,
      lightStrokeCount: 18,
      ...
      edgeOpacity: 0.31,
      edgeWidth: 3.45,
      underpaintOpacity: 0.60,
      strokeBreakChance: 0.095,
      strokeBuiltSurface: true,
      broadStrokeCount: 10,
      broadStrokeWidth: 4.4,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _SectionTitle(
          title: 'Crayon Soft · Round 11 · P01 Internal Fill',
          subtitle: 'P01 Clean Edge 외곽은 고정하고 내부 채움만 비교합니다. 목표는 꽉 찬 색면이 아니라 손으로 칠하다 일부가 덜 메워진 듯한 크레용 표면입니다.',
          fg: widget.fg,
          muted: widget.muted,
        ),
        const SizedBox(height: 12),
