...
const _candidates = <_CrayonCandidate>[
  // Mockup 01 family: 기본 크레용. 방향성보다 포근한 면감과 균형이 우선.
  _CrayonCandidate(
    id: '01-A',
    name: 'Basic Balanced',
    intent: '목업 1번 기준. 결은 보이되 한 덩어리의 부드러운 크레용 면으로 읽히는 기준안.',
    badge: '01 BASE',
  ...
  _CrayonCandidate(
    id: '01-B',
    name: 'Basic Dense',
    intent: '1번을 더 촘촘하게. 빈틈을 줄여 작은 크기에서도 색면을 가장 안정적으로 유지.',
    badge: '01 DENSE',
    config: CrayonTextureSpec(
      darkStrokeCount: 52,
      lightStrokeCount: 16,
      ...
      grainOpacity: 0.06,
      edgeOpacity: 0.07,
      underpaintOpacity: 0.11,
      strokeBreakChance: 0.035,
      strokeBuiltSurface: true,
      broadStrokeCount: 34,
      broadStrokeWidth: 4.05,
      broadStrokeOpacity: 0.18,
      angleJitterDeg: 6.0,
  ...
  _CrayonCandidate(
    id: '01-C',
    name: 'Basic Soft',
    intent: '1번의 포근함을 강화. 명암 대비와 외곽선을 낮춰 더 부드러운 크레용 면감.',
    badge: '01 SOFT',
    config: CrayonTextureSpec(
      darkStrokeCount: 38,
      lightStrokeCount: 20,
  ...
  _CrayonCandidate(
    id: '01-D',
    name: 'Basic Handmade',
    intent: '1번을 손그림 쪽으로 한 단계 이동. 방향은 유지하되 획 길이와 굵기 편차를 자연스럽게.',
    badge: '01 HAND',
    config: CrayonTextureSpec(
      darkStrokeCount: 40,
      lightStrokeCount: 15,
  ...
  // Mockup 02 family: 사선 크레용. 사선 리듬과 생동감이 우선.
  _CrayonCandidate(
    id: '02-A',
    name: 'Diagonal Clean',
    intent: '목업 2번 기준. 사선 방향은 또렷하게, 획 간격과 굵기는 정돈된 기준안.',
    badge: '02 BASE',
    config: CrayonTextureSpec(
      darkStrokeCount: 43,
      lightStrokeCount: 13,
  ...
  _CrayonCandidate(
    id: '02-B',
    name: 'Diagonal Dense',
    intent: '2번의 사선을 더 촘촘하게. 줄무늬보다는 밀도 높은 크레용 결로 보이도록 조정.',
    badge: '02 DENSE',
    config: CrayonTextureSpec(
      darkStrokeCount: 54,
      lightStrokeCount: 14,
  ...
  _CrayonCandidate(
    id: '02-C',
    name: 'Diagonal Natural',
    intent: '2번의 사선 리듬을 유지하면서 약간의 각도·길이 편차를 넣어 기계적인 선 느낌을 제거.',
    badge: '02 NATURAL',
    config: CrayonTextureSpec(
      darkStrokeCount: 44,
      lightStrokeCount: 15,
  ...
  _CrayonCandidate(
    id: '02-D',
    name: 'Diagonal Mockup Aim',
    intent: '2번 목업의 따뜻하고 생동감 있는 사선 결을 가장 직접적으로 노리는 타깃안.',
    badge: '02 TARGET',
    config: CrayonTextureSpec(
      darkStrokeCount: 47,
      lightStrokeCount: 14,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _SectionTitle(
          title: 'Crayon Soft · Round 4 · Mockup 01 / 02 Focus',
          subtitle: '목업의 01 기본 크레용과 02 사선 크레용 두 방향만 남기고, 각 방향을 4개씩 실제 렌더로 좁혀 비교합니다.',
          fg: widget.fg,
          muted: widget.muted,
        ),
        const SizedBox(height: 12),
