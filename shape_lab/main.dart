...
const _candidates = <_CrayonCandidate>[
  _CrayonCandidate(
    id: 'CR-R2-01',
    name: 'Thick Crayon Outline',
    intent: '두꺼운 외곽선 존재감 복원 기준안. 내부는 충분히 채우고 테두리에만 약한 dry break.',
    badge: 'THICK',
    config: CrayonTextureSpec(
      ...
      grainOpacity: 0.14,
      edgeOpacity: 0.16,
      underpaintOpacity: 0.86,
      strokeBreakChance: 0.055,
      strokeBuiltSurface: true,
      broadStrokeCount: 17,
      broadStrokeWidth: 5.4,
      broadStrokeOpacity: 0.25,
      angleJitterDeg: 6.5,
      strokeWidthJitter: 0.24,
      strokeLengthMin: 0.70,
      strokeLengthMax: 1.0,
      gapChance: 0.035,
      toneVariation: 0.075,
      edgeWidth: 1.75,
      edgeMode: CrayonEdgeMode.broken,
      edgeSegmentLength: 10.5,
      edgeSegmentGap: 5.0,
      edgeOffsetJitter: 0.85,
      edgeWidthJitter: 0.24,
      edgeOpacityJitter: 0.24,
      directionPassCount: 1,
      directionSpreadDeg: 0.0,
      laneScatter: 0.40,
      pressureVariation: 0.34,
      paperToothCount: 38,
      paperToothWidthMin: 0.12,
      paperToothWidthMax: 0.52,
      paperToothLengthMin: 0.42,
      paperToothLengthMax: 1.85,
      paperToothStrength: 0.56,
      grainRadiusMin: 0.12,
      grainRadiusMax: 0.74,
      contourBaseWidth: 3.85,
      contourBaseOpacity: 0.72,
      contourGapCount: 8,
      contourGapLengthMin: 1.4,
      contourGapLengthMax: 3.2,
      contourGapWidthScale: 0.78,
      contourGapStrength: 0.90,
    ),
  ),
  _CrayonCandidate(
    id: 'CR-R2-02',
    name: 'Broken Thick Outline',
    intent: '메인 후보. 굵은 테두리는 분명히 남기되 군데군데 wax가 빠지고 진하기가 흔들리는 외곽.',
    badge: 'MAIN',
    config: CrayonTextureSpec(
      darkStrokeCount: 29,
      lightStrokeCount: 2,
      ...
      strokeBreakChance: 0.075,
      strokeBuiltSurface: true,
      broadStrokeCount: 18,
      broadStrokeWidth: 5.55,
      broadStrokeOpacity: 0.26,
      angleJitterDeg: 7.5,
      strokeWidthJitter: 0.29,
      strokeLengthMin: 0.64,
      ...
      directionSpreadDeg: 0.0,
      laneScatter: 0.47,
      pressureVariation: 0.44,
      paperToothCount: 48,
      paperToothWidthMin: 0.12,
      paperToothWidthMax: 0.58,
      paperToothLengthMin: 0.42,
      paperToothLengthMax: 2.10,
      paperToothStrength: 0.62,
      grainRadiusMin: 0.13,
      grainRadiusMax: 0.92,
  ...
  _CrayonCandidate(
    id: 'CR-R2-03',
    name: 'Wax Rim Outline',
    intent: '외곽선을 선처럼 분리하기보다 가장자리에 wax가 더 쌓인 듯 연결시키는 부드러운 rim형.',
    badge: 'WAX RIM',
    config: CrayonTextureSpec(
      darkStrokeCount: 27,
      lightStrokeCount: 1,
      ...
      grainOpacity: 0.20,
      edgeOpacity: 0.12,
      underpaintOpacity: 0.88,
      strokeBreakChance: 0.045,
      strokeBuiltSurface: true,
      broadStrokeCount: 22,
      broadStrokeWidth: 6.05,
      broadStrokeOpacity: 0.27,
      angleJitterDeg: 6.0,
      strokeWidthJitter: 0.30,
      strokeLengthMin: 0.68,
      strokeLengthMax: 1.0,
      gapChance: 0.030,
      toneVariation: 0.095,
      edgeWidth: 1.55,
      edgeMode: CrayonEdgeMode.overfill,
      edgeSegmentLength: 9.8,
      edgeSegmentGap: 4.8,
      edgeOffsetJitter: 0.95,
      edgeWidthJitter: 0.28,
      ...
      paperToothCount: 34,
      paperToothWidthMin: 0.13,
      paperToothWidthMax: 0.56,
      paperToothLengthMin: 0.45,
      paperToothLengthMax: 1.95,
      paperToothStrength: 0.52,
      grainRadiusMin: 0.18,
      grainRadiusMax: 1.18,
      contourBaseWidth: 3.15,
      contourBaseOpacity: 0.54,
      contourGapCount: 9,
      contourGapLengthMin: 1.2,
      contourGapLengthMax: 3.0,
      contourGapWidthScale: 0.74,
      contourGapStrength: 0.84,
    ),
  ),
  _CrayonCandidate(
    id: 'CR-R2-04',
    name: 'Balanced Contour Wax',
    intent: '두꺼운 outline, 본색 유지, paper tooth와 wax grain을 균형 조합한 실사용 기준안.',
    badge: 'BALANCED',
    config: CrayonTextureSpec(
      darkStrokeCount: 30,
      lightStrokeCount: 2,
      ...
      grainOpacity: 0.17,
      edgeOpacity: 0.16,
      underpaintOpacity: 0.84,
      strokeBreakChance: 0.065,
      strokeBuiltSurface: true,
      broadStrokeCount: 19,
      broadStrokeWidth: 5.65,
      broadStrokeOpacity: 0.26,
      angleJitterDeg: 7.0,
      strokeWidthJitter: 0.28,
      ...
      edgeWidth: 1.78,
      edgeMode: CrayonEdgeMode.hybrid,
      edgeSegmentLength: 9.4,
      edgeSegmentGap: 5.4,
      edgeOffsetJitter: 0.98,
      edgeWidthJitter: 0.31,
      edgeOpacityJitter: 0.34,
      edgeBandWidth: 1.8,
      overflowAmount: 1.10,
      directionPassCount: 2,
      directionSpreadDeg: 5.0,
      laneScatter: 0.46,
      pressureVariation: 0.50,
      paperToothCount: 44,
      paperToothWidthMin: 0.12,
      paperToothWidthMax: 0.56,
      paperToothLengthMin: 0.42,
      paperToothLengthMax: 2.00,
      paperToothStrength: 0.58,
      grainRadiusMin: 0.14,
      grainRadiusMax: 0.98,
      contourBaseWidth: 3.50,
      contourBaseOpacity: 0.64,
      contourGapCount: 12,
      contourGapLengthMin: 1.4,
      contourGapLengthMax: 3.7,
      contourGapWidthScale: 0.82,
      contourGapStrength: 0.90,
    ),
  ),
];
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _SectionTitle(
          title: 'Crayon Soft · Round 2 · Thick Crayon Contour',
          subtitle: 'Round 1의 과도한 공백과 색 빠짐을 줄이고, 사라졌던 두꺼운 크레용 외곽선을 독립 2-pass contour로 복원합니다. 외곽선 자체도 군데군데 wax가 비도록 유지하면서 본색과 coverage를 회복한 4안을 비교합니다.',
          fg: widget.fg,
          muted: widget.muted,
        ),
        const SizedBox(height: 12),
...
String _shortCrayonConfig(CrayonTextureSpec config) {
  return 'Contour ' +
      config.contourBaseWidth.toStringAsFixed(1) +
      ' · Gap ' +
      config.contourGapCount.toString() +
      ' · Fill ' +
