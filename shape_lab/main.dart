...
const _candidates = <_CrayonCandidate>[
  _CrayonCandidate(
    id: 'E02',
    name: 'Broken Edge · Ref',
    intent: '이전 라운드에서 좋았던 끊긴 외곽 기준안. 비교축으로 유지.',
    badge: 'REF',
  ...
  _CrayonCandidate(
    id: 'E05',
    name: 'Broken + Overfill · Base',
    intent: '현재 최선 기준안. 내부 질감은 고정하고 가장자리만 파생.',
    badge: 'BASE',
    config: CrayonTextureSpec(
      darkStrokeCount: 32,
      lightStrokeCount: 14,
  ...
  _CrayonCandidate(
    id: 'P01',
    name: 'Clean Edge',
    intent: 'E05의 손맛은 유지하되 삐져나옴과 외곽 두께를 살짝 정돈.',
    badge: 'CLEAN',
    config: CrayonTextureSpec(
      darkStrokeCount: 32,
      lightStrokeCount: 14,
  ...
  _CrayonCandidate(
    id: 'P02',
    name: 'Rough Edge',
    intent: '끊김·두께·위치 편차를 키워 손으로 칠한 흔적을 더 적극적으로 노출.',
    badge: 'ROUGH',
    config: CrayonTextureSpec(
      darkStrokeCount: 32,
      lightStrokeCount: 14,
      ...
      edgeWidthJitter: 0.50,
      edgeOpacityJitter: 0.46,
      edgeBandWidth: 3.7,
      overflowAmount: 2.7,
    ),
  ),
  _CrayonCandidate(
    id: 'P03',
    name: 'Soft Spill',
    intent: '튀어나오는 획은 유지하되 더 얇고 가볍게 만들어 지저분함을 줄임.',
    badge: 'SOFT',
    config: CrayonTextureSpec(
      darkStrokeCount: 32,
      lightStrokeCount: 14,
      ...
      edgeSegmentGap: 5.1,
      edgeOffsetJitter: 1.00,
      edgeWidthJitter: 0.30,
  ...
  _CrayonCandidate(
    id: 'P04',
    name: 'Tight Rhythm',
    intent: '짧은 가장자리 조각을 더 촘촘하게 배치해 꼭짓점과 곡선부의 벡터감을 약화.',
    badge: 'TIGHT',
    config: CrayonTextureSpec(
      darkStrokeCount: 32,
      lightStrokeCount: 14,
  ...
  _CrayonCandidate(
    ...
    intent: '구간별 밀도와 외곽 편차를 크게 만들어 가장 손칠다운 불균일 리듬을 탐색.',
    badge: 'RHYTHM',
    config: CrayonTextureSpec(
      darkStrokeCount: 32,
      lightStrokeCount: 14,
      ...
      toneVariation: 0.10,
      edgeMode: CrayonEdgeMode.hybrid,
      edgeSegmentLength: 9.2,
      edgeSegmentGap: 6.4,
      edgeOffsetJitter: 1.55,
      edgeWidthJitter: 0.56,
      edgeOpacityJitter: 0.54,
      edgeBandWidth: 3.6,
      overflowAmount: 2.55,
    ),
  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _SectionTitle(
          title: 'Crayon Soft · Round 10 · E05 Edge Polish',
          subtitle: 'G02 Thin Hatch 내부 질감은 고정하고 외곽 표현만 분리 비교합니다. 목표는 별도 벡터 테두리보다 크레용 획이 쌓여 자연스럽게 생긴 실루엣입니다.',
          fg: widget.fg,
          muted: widget.muted,
        ),
        const SizedBox(height: 12),
