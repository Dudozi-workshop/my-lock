    ...
    return Column(
      ...
      children: [
        ...
        _SectionTitle(
          ...
          subtitle: '목업의 01 기본 크레용과 02 사선 크레용에 집중합니다. 이번 라운드는 팔레트 색을 유지하고, 더 두껍고 결이 있는 크레파스 테두리를 적용합니다.',
          fg: widget.fg,
          muted: widget.muted,
        ),
        const SizedBox(height: 12),
