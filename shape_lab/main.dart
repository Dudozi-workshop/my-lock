...
const _candidates = <_CrayonCandidate>[
  _CrayonCandidate(
    id: 'R01',
    name: 'P01 Fill · Ref',
    intent: '현재 P01 내부 기준. 밝은 pigment가 보이는 기존 비교축.',
    badge: 'REF',
  ...
  _CrayonCandidate(
    id: 'R02',
    name: 'No Light Overlay',
    intent: '밝은 덧칠을 거의 제거. 공백처럼 보이던 밝은 pigment 원인 분리.',
    badge: 'CAUSE',
    config: CrayonTextureSpec(
      darkStrokeCount: 31,
      lightStrokeCount: 5,
  ...
  _CrayonCandidate(
    id: 'R03',
    name: 'True Paper Gap',
    intent: '밝은색을 얹지 않고 실제 pigment를 가늘게 지워 배경이 비치는 안.',
    badge: 'GAP',
    config: CrayonTextureSpec(
      darkStrokeCount: 31,
      lightStrokeCount: 5,
  ...
  _CrayonCandidate(
    id: 'R04',
    name: 'Dry Paper Gap',
    intent: '실제 얇은 공백을 늘려 마른 종이에 크레용이 덜 먹은 느낌.',
    badge: 'DRY',
    config: CrayonTextureSpec(
      darkStrokeCount: 28,
      lightStrokeCount: 4,
  ...
  _CrayonCandidate(
    id: 'Z01',
    name: 'Zigzag Wax',
    intent: '번개처럼 좌우로 꺾이며 왕복하는 지그재그 손칠 방향.',
    badge: 'NEW',
    config: CrayonTextureSpec(
      darkStrokeCount: 26,
      lightStrokeCount: 7,
  ...
  _CrayonCandidate(
    id: 'Z02',
    name: 'Zigzag + Paper Gap',
    intent: '지그재그 손칠에 얇은 실제 공백을 섞어 더 아날로그한 조합.',
    badge: 'MIX',
    config: CrayonTextureSpec(
      darkStrokeCount: 25,
      lightStrokeCount: 5,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _SectionTitle(
          title: 'Crayon Soft · Round 12 · Negative Space + Zigzag',
          subtitle: '밝은색을 덧대는 방식과 실제 pigment가 비는 방식을 분리 비교하고, 사선 반복 외에 번개형 지그재그 손칠을 추가합니다. P01 Clean Edge 외곽은 그대로 고정합니다.',
          fg: widget.fg,
          muted: widget.muted,
        ),
        const SizedBox(height: 12),
