...
const _candidates = <_CrayonCandidate>[
  _CrayonCandidate(
    id: 'F01',
    name: 'E04 · Color Lock',
    intent: 'E04 두께감 유지. 원색을 100% 바탕으로 고정한 새 기준점.',
    badge: 'BASE',
  ...
  _CrayonCandidate(
    id: 'F02',
    name: 'Crayon Edge',
    intent: 'F01 내부색 고정 + 외곽만 더 여러 번 문질러 그린 느낌.',
    badge: 'EDGE',
    config: CrayonTextureSpec(
      darkStrokeCount: 14,
      lightStrokeCount: 4,
  ...
  _CrayonCandidate(
    id: 'F03',
    name: 'Rough Multi-pass',
    intent: '색은 그대로 두고 외곽 패스와 흔들림을 더 강하게.',
    badge: 'ROUGH',
    config: CrayonTextureSpec(
      darkStrokeCount: 14,
      lightStrokeCount: 4,
  ...
  _CrayonCandidate(
    id: 'F04',
    name: 'Natural Fill',
    intent: '외곽은 F02 수준, 내부 획만 조금 더 불규칙하게.',
    badge: 'FILL',
    config: CrayonTextureSpec(
      darkStrokeCount: 13,
      lightStrokeCount: 4,
      ...
      strokeBuiltSurface: true,
      broadStrokeCount: 19,
      broadStrokeWidth: 6.10,
      broadStrokeOpacity: 0.18,
      angleJitterDeg: 13.0,
      strokeWidthJitter: 0.26,
  ...
  _CrayonCandidate(
    id: 'F05',
    name: 'Dense Wax',
    intent: '원색 유지 + 촘촘한 크레파스 압력 자국. 가장 또렷한 채색형.',
    badge: 'DENSE',
    config: CrayonTextureSpec(
      darkStrokeCount: 18,
      lightStrokeCount: 5,
      ...
      strokeBuiltSurface: true,
      broadStrokeCount: 25,
      broadStrokeWidth: 5.90,
      broadStrokeOpacity: 0.17,
      angleJitterDeg: 4.5,
      strokeWidthJitter: 0.11,
  ...
  _CrayonCandidate(
    ...
    intent: '원색 고정 + F02 외곽 + F04 손칠을 균형 있게 조합한 목표 후보.',
    badge: 'TARGET',
    config: CrayonTextureSpec(
      darkStrokeCount: 15,
      lightStrokeCount: 4,
