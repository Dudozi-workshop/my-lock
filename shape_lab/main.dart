...
const _candidates = <_CrayonCandidate>[
  _CrayonCandidate(
    id: 'E01',
    name: 'No Outline',
    intent: 'G02 Thin Hatch 내부는 유지하고 외곽선을 완전히 제거.',
    badge: 'NONE',
    config: CrayonTextureSpec(
      ...
      gapChance: 0.035,
      toneVariation: 0.10,
      edgeMode: CrayonEdgeMode.none,
    ),
  ),
  _CrayonCandidate(
    id: 'E02',
    name: 'Broken Edge',
    intent: '짧게 끊긴 크레용 조각으로 외곽선을 구성.',
    badge: 'BROKEN',
    config: CrayonTextureSpec(
      darkStrokeCount: 32,
      lightStrokeCount: 14,
  ...
  _CrayonCandidate(
    id: 'E03',
    name: 'Edge Scribble',
    intent: '정확한 contour 대신 가장자리 밴드 안에 짧은 손칠 획 분산.',
    badge: 'SCRIBBLE',
    config: CrayonTextureSpec(
      darkStrokeCount: 32,
      lightStrokeCount: 14,
      ...
      edgeSegmentLength: 11.5,
      edgeOffsetJitter: 1.4,
      edgeBandWidth: 3.8,
  ...
  _CrayonCandidate(
    id: 'E04',
    name: 'Overfill',
    intent: '일부 획을 실루엣 밖으로 삐져나오게 해 손색칠 경계를 유도.',
    badge: 'OVER',
    config: CrayonTextureSpec(
      darkStrokeCount: 32,
      lightStrokeCount: 14,
  ...
  _CrayonCandidate(
    id: 'E05',
    name: 'Broken + Overfill',
    intent: '끊긴 외곽과 약한 삐져나옴을 결합한 절충안.',
    badge: 'HYBRID',
    config: CrayonTextureSpec(
      darkStrokeCount: 32,
      lightStrokeCount: 14,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _SectionTitle(
          title: 'Crayon Soft · Round 9 · Edge Lab',
