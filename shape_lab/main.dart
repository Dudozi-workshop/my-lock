...
const _candidates = <_CrayonCandidate>[
  _CrayonCandidate(
    id: 'R03',
    name: 'True Paper Gap · Ref',
    intent: 'Round 12 선택 기준. 실제 pigment가 비어 배경이 보이는 negative space.',
    badge: 'REF',
  ...
  _CrayonCandidate(
    id: 'R04',
    name: 'Dry Paper Gap · Ref',
    intent: 'Round 12 선택 기준. 실제 빈 틈과 마른 종이 질감.',
    badge: 'REF',
    config: CrayonTextureSpec(
      darkStrokeCount: 28,
      lightStrokeCount: 4,
      ...
      strokeBuiltSurface: true,
      broadStrokeCount: 10,
      broadStrokeWidth: 3.9,
      broadStrokeOpacity: 0.16,
      angleJitterDeg: 6.2,
      strokeWidthJitter: 0.27,
      strokeLengthMin: 0.64,
      strokeLengthMax: 0.93,
      gapChance: 0.075,
      toneVariation: 0.14,
      negativeGapCount: 16,
      negativeGapWidth: 0.88,
    ),
  ),
  _CrayonCandidate(
    id: 'Z02',
    name: 'Zigzag + Paper Gap · Ref',
    intent: 'Round 12 메인 베이스. 왕복형 손칠 + 실제 paper gap.',
    badge: 'BASE',
    config: CrayonTextureSpec(
      darkStrokeCount: 25,
      lightStrokeCount: 5,
      ...
      gapChance: 0.035,
      toneVariation: 0.12,
      strokePattern: CrayonStrokePattern.zigzag,
      zigzagAmplitude: 4.2,
      zigzagCycles: 7,
      negativeGapCount: 8,
      negativeGapWidth: 0.66,
    ),
  ),
  _CrayonCandidate(
    id: 'C01',
    name: 'Clean Zigzag',
    intent: 'Z02의 왕복 결은 유지하고 공백·grain·break를 절제한 안정형.',
    badge: 'POLISH',
    config: CrayonTextureSpec(
      darkStrokeCount: 28,
      lightStrokeCount: 4,
      ...
      angleJitterDeg: 2.6,
      strokeWidthJitter: 0.16,
      strokeLengthMin: 0.82,
      strokeLengthMax: 1.0,
      gapChance: 0.025,
      toneVariation: 0.10,
      strokePattern: CrayonStrokePattern.zigzag,
      ...
      zigzagCycles: 7,
      negativeGapCount: 6,
      negativeGapWidth: 0.58,
    ),
  ),
  _CrayonCandidate(
    id: 'C02',
    name: 'Dry Zigzag',
    intent: 'Z02에 R04의 dry grain과 끊김을 이식한 감성 강화형.',
    badge: 'POLISH',
    config: CrayonTextureSpec(
      darkStrokeCount: 26,
      lightStrokeCount: 3,
      ...
      edgeBandWidth: 2.8,
      overflowAmount: 1.8,
      underpaintOpacity: 0.79,
      strokeBreakChance: 0.10,
      strokeBuiltSurface: true,
      broadStrokeCount: 9,
      broadStrokeWidth: 3.9,
      broadStrokeOpacity: 0.15,
      angleJitterDeg: 5.8,
      strokeWidthJitter: 0.27,
      ...
      zigzagCycles: 7,
      negativeGapCount: 14,
      negativeGapWidth: 0.80,
    ),
  ),
  _CrayonCandidate(
    id: 'C03',
    name: 'Balanced Master',
    intent: 'Z02 기반 + R03의 정돈된 공백 + R04의 dry texture를 중간값으로 조합.',
    badge: 'MASTER?',
    config: CrayonTextureSpec(
      darkStrokeCount: 27,
      lightStrokeCount: 4,
      ...
      edgeBandWidth: 2.8,
      overflowAmount: 1.8,
      underpaintOpacity: 0.815,
      strokeBreakChance: 0.072,
      strokeBuiltSurface: true,
      broadStrokeCount: 10,
      broadStrokeWidth: 4.0,
      broadStrokeOpacity: 0.16,
      ...
      zigzagCycles: 7,
      negativeGapCount: 10,
      negativeGapWidth: 0.70,
    ),
  ),
  _CrayonCandidate(
    id: 'C04',
    name: 'Dense Wax',
    intent: '공백을 줄이고 pigment coverage를 높여 실제 앱 크기에서 안정성을 보는 밀도형.',
    badge: 'POLISH',
    config: CrayonTextureSpec(
      darkStrokeCount: 32,
      lightStrokeCount: 4,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _SectionTitle(
          title: 'Crayon Soft · Round 13 · Finish Polish',
          subtitle: 'R03 · R04 · Z02의 장점을 기준으로 최종 4개 조합을 좁힙니다. P01 Clean Edge 외곽은 고정하고, 실제 negative space · dry grain · zigzag 왕복 손칠의 균형만 다듬습니다.',
          fg: widget.fg,
          muted: widget.muted,
        ),
        const SizedBox(height: 12),
