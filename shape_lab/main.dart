                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'LAB 012 · Crayon stroke-built renderer',
...
const _candidates = <_CrayonCandidate>[
  _CrayonCandidate(
    id: 'R3-A',
    name: 'Stroke Build Basic',
    intent: '넓은 밑획 + 주획으로 색면 자체를 만드는 기준안.',
    badge: 'BASE',
  ...
  _CrayonCandidate(
    id: 'R3-B',
    name: 'Paper Gap Focus',
    intent: '종이색 비침과 짧은 획을 늘려 목업의 덜 채운 느낌을 강화.',
    badge: 'GAP',
    config: CrayonTextureSpec(
      darkStrokeCount: 40,
      lightStrokeCount: 11,
  ...
  _CrayonCandidate(
    id: 'R3-C',
    name: 'Handcrafted Variation',
    intent: '획 길이·각도·농도 편차를 키워 손으로 슥슥 칠한 느낌을 강화.',
    badge: 'HAND',
    config: CrayonTextureSpec(
      darkStrokeCount: 39,
      lightStrokeCount: 16,
  ...
  _CrayonCandidate(
    id: 'R3-D',
    name: 'Childlike Rough',
    intent: '끊김·빈틈·불균일성을 가장 크게 둔 거친 크레용 실험안.',
    badge: 'ROUGH',
    config: CrayonTextureSpec(
      darkStrokeCount: 31,
      lightStrokeCount: 10,
      ...
      grainOpacity: 0.09,
      edgeOpacity: 0.045,
      underpaintOpacity: 0.025,
      strokeBreakChance: 0.22,
      strokeBuiltSurface: true,
      broadStrokeCount: 19,
      broadStrokeWidth: 4.8,
      broadStrokeOpacity: 0.13,
      angleJitterDeg: 14.0,
      strokeWidthJitter: 0.38,
      strokeLengthMin: 0.35,
      strokeLengthMax: 0.86,
      gapChance: 0.23,
      toneVariation: 0.18,
    ),
  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _SectionTitle(
          title: 'Crayon Soft · Round 3 · Stroke-built Renderer',
          subtitle: '단색 면 위에 선을 얹는 방식을 버리고, 실제 획이 누적되어 색면이 되는 4개 렌더 구조를 비교합니다.',
          fg: widget.fg,
          muted: widget.muted,
        ),
        const SizedBox(height: 12),
