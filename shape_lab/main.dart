...
const _candidates = <_CrayonCandidate>[
  _CrayonCandidate(
    id: 'E01',
    name: '3px Edge · 2px Fill',
    intent: '기본형. 굵은 외곽과 내부 크레파스 채색의 최소 기준.',
    badge: 'BASE',
    config: CrayonTextureSpec(
      ...
      strokeBreakChance: 0.035,
      strokeBuiltSurface: true,
      broadStrokeCount: 24,
      broadStrokeWidth: 4.40,
      broadStrokeOpacity: 0.27,
      angleJitterDeg: 4.0,
      strokeWidthJitter: 0.12,
  ...
  _CrayonCandidate(
    id: 'E02',
    name: '3px Edge · 3px Fill',
    intent: '외곽과 내부 획 두께를 거의 맞춰 하나의 크레파스로 그린 통일감 확인.',
    badge: 'SAME BRUSH',
    config: CrayonTextureSpec(
      darkStrokeCount: 14,
      lightStrokeCount: 5,
      ...
      edgeWidth: 6.00,
      edgeTexture: 0.18,
      underpaintOpacity: 0.06,
      strokeBreakChance: 0.03,
      strokeBuiltSurface: true,
      broadStrokeCount: 21,
      broadStrokeWidth: 6.20,
      broadStrokeOpacity: 0.25,
      angleJitterDeg: 4.0,
      strokeWidthJitter: 0.13,
  ...
  _CrayonCandidate(
    id: 'E03',
    name: '4px Edge · 2.5px Fill',
    intent: '외곽 존재감을 먼저 강화. 내부는 한 단계 얇게 유지.',
    badge: 'BOLD EDGE',
    config: CrayonTextureSpec(
      darkStrokeCount: 15,
      lightStrokeCount: 5,
      ...
      edgeWidth: 8.00,
      edgeTexture: 0.22,
      underpaintOpacity: 0.07,
      strokeBreakChance: 0.04,
      strokeBuiltSurface: true,
      broadStrokeCount: 22,
      broadStrokeWidth: 5.40,
      broadStrokeOpacity: 0.27,
      angleJitterDeg: 5.0,
      strokeWidthJitter: 0.14,
  ...
  _CrayonCandidate(
    id: 'E04',
    name: '4px Edge · 3px Fill',
    intent: '굵은 외곽과 굵은 내부 채색을 함께 적용한 크레파스 기본 후보.',
    badge: 'THICK',
    config: CrayonTextureSpec(
      darkStrokeCount: 14,
      lightStrokeCount: 5,
  ...
  _CrayonCandidate(
    id: 'E05',
    name: 'Double Outline',
    intent: 'E04 기반. 외곽을 여러 번 덧그려 아이가 힘주어 테두리를 그린 느낌.',
    badge: '2–4 PASS',
    config: CrayonTextureSpec(
      darkStrokeCount: 14,
      lightStrokeCount: 5,
  ...
  _CrayonCandidate(
    id: 'E06',
    name: 'Uneven Kid Fill',
    intent: 'E04 기반. 내부 획 길이·각도·굵기 편차를 크게 주어 서툰 손칠 감성을 강화.',
    badge: 'HAND',
    config: CrayonTextureSpec(
      darkStrokeCount: 13,
      lightStrokeCount: 5,
  ...
  _CrayonCandidate(
    id: 'E07',
    name: 'Paper Gaps',
    intent: 'E05 기반. 종이 바탕이 더 보이도록 덜 채우고 끊긴 획을 남긴 크레파스 질감.',
    badge: 'GAPS',
    config: CrayonTextureSpec(
      darkStrokeCount: 11,
      lightStrokeCount: 4,
      ...
      edgeWidth: 8.00,
      edgeTexture: 0.72,
      underpaintOpacity: 0.01,
      strokeBreakChance: 0.16,
      strokeBuiltSurface: true,
      broadStrokeCount: 17,
      broadStrokeWidth: 6.20,
      broadStrokeOpacity: 0.28,
      angleJitterDeg: 13.0,
      strokeWidthJitter: 0.27,
      strokeLengthMin: 0.36,
  ...
  _CrayonCandidate(
    ...
    intent: '굵은 같은색 외곽 + 굵은 사선 채색 + 적당한 빈틈을 합친 레퍼런스 집중형.',
    badge: 'TARGET',
    config: CrayonTextureSpec(
      darkStrokeCount: 15,
      lightStrokeCount: 5,
      ...
      edgeTexture: 0.62,
      underpaintOpacity: 0.06,
      strokeBreakChance: 0.085,
      strokeBuiltSurface: true,
      broadStrokeCount: 21,
      broadStrokeWidth: 5.80,
      broadStrokeOpacity: 0.27,
      angleJitterDeg: 11.0,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _SectionTitle(
          title: 'Crayon Soft · Round 6 · Thick Crayon Brush',
          subtitle: '가는 색연필 결을 버리고, 굵은 같은색 크레파스 브러시로 외곽과 내부를 함께 그립니다. Edge 6~8은 58px 실사용에서 약 3~4px로 보입니다.',
          fg: widget.fg,
          muted: widget.muted,
        ),
        const SizedBox(height: 12),
